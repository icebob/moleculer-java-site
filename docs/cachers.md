...
### Custom cacher
You can also create your custom cache module. We recommend to copy the source of [MemoryCacher](https://github.com/moleculer-java/moleculer-java/blob/master/src/cachers/memory.js) or [RedisCacher](https://github.com/moleculer-java/moleculer-java/blob/master/src/cachers/redis.js) and implement the `get`, `set`, `del` and `clean` methods.
